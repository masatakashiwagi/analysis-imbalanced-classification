...
Purpose: over-sampling and under-sampling for imbalanced classifications.
...
Over-sampling technique: SMOTE (Synthetic Minority Oversampling Technique) & ADASYN (Adaptive Synthetic sampling)
